...
const HUDA_PHOTO = "data:image/jpeg;base64,";
...
function HeroSection() {
      ...
      <FadeIn delay={0} y={-20}>
        <nav
          style={{
            ...
            padding: "clamp(18px,3vw,32px) clamp(20px,4vw,48px) 0",
          }}
        >
          {navLinks.map((link) => (
            <a
  ...
  style={{
    ...
    whiteSpace: "nowrap",
    width: "100%",
    fontSize: "clamp(2.2rem, 10vw, 9rem)", // ← was clamp(3rem, 17.5vw, 22vw)
  ...
  Hi, i&apos;m huda
      ...
      <div
        style={{
          ...
          justifyContent: "space-between",
          alignItems: "flex-end",
          padding: "0 clamp(20px,4vw,48px) clamp(24px,3vw,40px)",
...
>
  <FadeIn delay={0.35} y={20}>
    ...
    >
      A software engineer driven by crafting smart and unforgettable
      digital experiences
    </p>
  </FadeIn>
</div>
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "clamp(32px,5vw,64px)", zIndex: 1 }}>
        ...
        <AnimatedText
          text="A fresh graduate in Software Engineering from UMT, i specialise in frontend development, machine learning, and NLP. i focus on building responsive, user-centered digital products that combine clean code with compelling design. With 2+ years of content writing experience, i bridge the gap between technical development and strong communication. Let's build something incredible together!"
        />
...
const services = [
  {
    ...
    desc: "Building responsive, interactive interfaces using HTML5, CSS3, JavaScript, Bootstrap, and React with a strong focus on UI/UX performance.",
  },
  {
    num: "02",
  ...
  },
  {
    ...
    desc: "Connecting React frontends to backend APIs (Django REST) and databases (MySQL) to ship end-to-end features with clean architecture.",
  },
];
...
const projects = [
  ...
  },
  {
    ...
    desc: "A data analytics dashboard for cricket match insights, featuring interactive visualisations, performance breakdowns, and statistical analysis to surface patterns and trends across player and team data.",
    tech: ["Python", "Pandas", "Data Visualisation", "Analytics"],
    link: "https://github.com/hudamasood",
    images: {
